...
Contributions are welcome, from bug reports to new source adapters. See [CONTRIBUTING.md](CONTRIBUTING.md) for how to set up a development environment, run the tests and checks (`unittest`, coverage, `ruff`, `mypy`), and open a pull request. By participating you agree to the project's [Code of Conduct](CODE_OF_CONDUCT.md).
